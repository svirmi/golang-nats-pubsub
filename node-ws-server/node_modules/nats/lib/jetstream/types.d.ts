import { Consumer, OrderedConsumerOptions } from "nats/lib/jetstream/consumer";
import { JetStreamOptions, MsgHdrs, Nanos, NatsError, Payload, QueuedIterator, ReviverFn, Sub } from "nats/lib/nats-base-client/core";
export type { JetStreamManagerOptions, JetStreamOptions, } from "nats/lib/nats-base-client/core";
import { TypedSubscriptionOptions } from "nats/lib/nats-base-client/typedsub";
import { ConsumerConfig, ConsumerInfo, DirectBatchOptions, DirectMsgRequest, JetStreamAccountStats, MsgRequest, Placement, PullOptions, PurgeOpts, PurgeResponse, Republish, StorageType, StreamAlternate, StreamConfig, StreamInfo, StreamInfoRequestOptions, StreamSource, StreamUpdateConfig } from "nats/lib/jetstream/jsapi_types";
import { JsMsg } from "nats/lib/jetstream/jsmsg";
import { BaseApiClient } from "nats/lib/jetstream/jsbaseclient_api";
import { ConsumerAPI } from "nats/lib/jetstream/jsmconsumer_api";
import { Lister } from "nats/lib/jetstream/jslister";
/**
 ...
 */
export type JetStreamSubscription = Sub<JsMsg> & Destroyable & Closed & ConsumerInfoable;
...
export declare enum DirectMsgHeaders {
    Stream = "Nats-Stream",
    Sequence = "Nats-Sequence",
    TimeStamp = "Nats-Time-Stamp",
    Subject = "Nats-Subject"
}
export declare enum RepublishHeaders {
    /**
